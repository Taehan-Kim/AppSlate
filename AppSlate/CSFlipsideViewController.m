...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        gearList = [[NSArray alloc] initWithObjects:
                    ...
                    [[NSDictionary alloc] initWithObjects:[NSArray arrayWithObjects:@"RSS Table", @"RSS Feed Table", @"gi_rsstable.png", NSNUM(CS_RSSTABLE), nil] forKeys:keys],
                    [[NSDictionary alloc] initWithObjects:[NSArray arrayWithObjects:@"Twitter Table", @"Twitter Timeline Table", @"gi_twtable.png", NSNUM(CS_TWTABLE), nil] forKeys:keys],
