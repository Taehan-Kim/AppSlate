...
//  AppSlate
//
//  Created by Taehan Kim on 12. 2. 16..
//  Copyright (c) 2012년 ChocolateSoft. All rights reserved.
//

#import "CSAnd.h"

@implementation CSAnd
...
-(id) initGear
{
    ...
    [(UIImageView*)csView setImage:[UIImage imageNamed:@"gi_and.png"]];
    ...
    self.info = NSLocalizedString(@"Logical AND", @"AND");
